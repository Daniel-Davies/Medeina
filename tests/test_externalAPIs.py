...
def testt():
    translateSpeciesList(['blackbird'])
    assert 1 == 2
# def testTakeIfMatchesGroup():
#     data = [('a','a',{'family':'felidae','X':'Y']), \
#             ('a','a',['family':'felidae','X':'Y']),
#             ('a','a',['family':'unknown','X':'Y']),
#             ('a','a',['family':'felidae','X':'Y']),
#             ('a','a',['family':'delphinidae','X':'Y']),
#             ('a','a',[])]
#     level = 'family'
#     group = 'felidae'

#     expected = 1
#     assert takeSpeciesMatchingGroupOnly(group,level,data) == expected
