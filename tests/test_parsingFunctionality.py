...
def testMakingUnique():
    ...
    expected =  [('Spec1', 'Spec2', {}), ('Spec3', 'Spec4', {}), ('Spec5', 'Spec2', {}), ('Spec6', 'Spec7', {})]
...
def testMakingUniqueWithMetas():
    ...
    expected =  [('Spec1', 'Spec2', {'M1':'M1'}), ('Spec3', 'Spec4', {'M2':'M2'}), ('Spec5', 'Spec2', {'M4':'M4'}), ('Spec6', 'Spec7', {'M3':'M3'})]
    assert makeUnique(headTailDataWithMetas) == expected
...
def testMakingUniqueWithVaryingMetas():
    ...
    expected =  [('Spec1', 'Spec2', {'M1':'M1','M4':'M4'}), 
...
def testDictToTuples():
    ...
    expected = [('Spec1', 'Spec2', {'M1': 'M1'}), ('Spec2', 'Spec3', {'M2': 'M2'}), ('Spec2', 'Spec4', {'M3': 'M3'}), ('Spec1', 'Spec4', {'M4': 'M4'})]
