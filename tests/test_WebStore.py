...
def testFileInitWhenExists(patch_exists,test_patch_write,patch_init_tracker):
    def link_tracker_effect():return
...
@patch('Medeina.webStore.writeObjToDateStore')
@patch('os.path.exists')
def testTrackerIdInitWhenExists(patch_exists,test_patch_write,test_patch_read,patch_assure):
    def assure_existence_effect(a):return
...
@patch('Medeina.webStore.writeObjToDateStore')
@patch('os.path.exists')
def testTrackerIdInitWhenNew(patch_exists,test_patch_write,test_patch_read,patch_assure):
    def assure_existence_effect(a):return
