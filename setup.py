...
setuptools.setup(
     ...
     install_requires=['pycountry','pandas','taxon_parser','networkx','numpy','msgpack','EcoNameTranslator','requests','pandas;python_version>="3.5"','pandas<0.21;python_version<"3.5"']
 )